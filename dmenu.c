...
static char *embed;
static int bh, mw, mh;
static int dmx = 150; /* put dmenu at this x offset */
static int dmy = 100; /* put dmenu at this y offset (measured from the bottom if topbar is 0) */
static unsigned int dmw = 300; /* make dmenu this wide */
